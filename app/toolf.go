...
/**
 * the following code presents Haversine formula, which is used to calculate
 * geometric distance according to longitude and latitude.
...
const rEarth = 6372797.560856 // m, using more concise value
...
// usage: fmt.Println(hsDist(degPos(36.12, -86.67), degPos(33.94, -118.40)))
